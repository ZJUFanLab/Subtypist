...
# marker_assay: Name of assay used for marker detection
# cluster.assay: Name of the assay in the Seurat object to use for clustering
> result <- Subtypist_merge(object=Seu,min.resolution=0.3,max.resolution=1.5,by=0.1,marker_assay="RNA",cluster_assay = "RNA")
